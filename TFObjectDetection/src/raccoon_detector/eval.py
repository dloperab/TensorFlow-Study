...
PATH_TO_CKPT = 'trained-inference-graphs/inference_graph_v1/frozen_inference_graph.pb'
...
# Detection
# Images
PATH_TO_TEST_IMAGES_DIR = 'images/eval/'
...
for image_path in TEST_IMAGE_PATHS:
  ...
  cv2.imwrite("detections/raccoon-{}_detection.jpg".format(counter), image_np)

  counter += 1

# show detected images
print("[INFO] show detections")
TEST_OUTPUT_IMAGE_PATHS = [os.path.join("detections/", 'raccoon-{}_detection.jpg'.format(i)) for i in range(1, 11)]
